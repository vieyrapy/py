...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td>Gs. <?php echo number_format($operation->total,0,',','.'); ?></td>
		<td>Gs. <?php echo number_format($operation->discount,0,',','.'); ?></td>
		<td>Gs. <?php echo number_format($operation->total-$operation->discount,0,',','.'); ?></td>
...
<h1>Total de ventas: Gs. <?php echo number_format($supertotal,0,',','.'); ?></h1>
