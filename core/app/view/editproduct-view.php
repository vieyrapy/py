...
<div class="form-group">
    ...
    <?php foreach($personas as $person):?>
      <option value="<?php echo $person->id;?>" <?php if($product->person_id!=null&& $product->person_id==$person->id){ echo "selected";}?>><?php echo $person->company;?></option>
    <?php endforeach;?>
      </select>    </div>
  </div>
