...
<tr >
	...
	<td><?php echo $product->name; ?></td>
	<td><?php if($product->person_id!=null){echo $product->getPerson()->company;}else{ echo "<center>----</center>"; }  ?></td>
	<td><b>Gs. <?php echo number_format($product->price_in,0,',','.'); ?></b></td>
	<td><b>Gs. <?php  $pt = $product->price_in*$p["q"]; $total +=$pt; echo number_format($pt,0,',','.'); ?></b></td>
...
<table class="table table-bordered" id="mi-tabla">
<tr>
	<td><p>Subtotal</p></td>
...
<script>
	$("#processsell").submit(function(e){
		...
		if(money<<?php echo $total;?>){
			...
			go = confirm("Cambio: Gs."+(money-<?php echo $total;?>));
			if(go){}
