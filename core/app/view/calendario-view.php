...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p class="lead">Guarda tus actividades a realizar</p>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="?view=editEventTitle">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="title" class="col-sm-2 control-label">Título de evento</label>
					<div class="col-sm-10">
					  <input type="text" name="title" class="form-control" id="title" placeholder="Title">
					</div>
				  </div>
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color">
						  <option value="">Choose</option>
						  <option style="color:#0071c5;" value="#0071c5">&#9724; Azúl</option>
						  <option style="color:#40E0D0;" value="#40E0D0">&#9724; Turquesa</option>
						  <option style="color:#008000;" value="#008000">&#9724; Verde</option>						  
						  <option style="color:#FFD700;" value="#FFD700">&#9724; Amarillo</option>
						  <option style="color:#FF8C00;" value="#FF8C00">&#9724; Naranja</option>
	...
	<script src='plugins/calendar/js/locale-all.js'></script>
	<script>
