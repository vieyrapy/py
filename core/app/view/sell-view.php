...
<tr >
	...
	<td><?php echo $product->name; ?></td>
	<td><b>Gs. <?php echo number_format($product->price_out,0,",","."); ?></b></td>
	<td><b>Gs. <?php  $pt = $product->price_out*$p["q"]; $total +=$pt; echo number_format($pt,0,",","."); ?></b></td>
...
<tr>
	<td><p>Subtotal</p></td>
	<td><p><b>Gs. <?php echo number_format($total*.84,0,",","."); ?></b></p></td>
</tr>
<tr>
	<td><p>IVA</p></td>
	<td><p><b>Gs. <?php echo number_format($total*.16,0,",","."); ?></b></p></td>
</tr>
<tr>
	<td><p>Total</p></td>
	<td><p><b>Gs. <?php echo number_format($total,0,",","."); ?></b></p></td>
</tr>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        ...
        <button class="btn btn-lg btn-primary"><i class="glyphicon"></i><i class="glyphicon glyphicon-usd"></i> Finalizar Venta</button>
        </label>
      </div>
    </div>
  </div>
...
<script>
	$("#processsell").submit(function(e){
		...
		if(money<(<?php echo $total;?>-discount)){
			...
			go = confirm("Cambio: Gs."+(money-(<?php echo $total;?>-discount ) ) );
			if(go){}
