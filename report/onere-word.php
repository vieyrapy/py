...
$table1->addCell()->addText($client->company);
...
$table2->addCell()->addText("Proveedor");
...
$table2->addCell()->addText($product->getPerson()->company);
$table2->addCell()->addText($product->barcode);
$table2->addCell()->addText($operation->q);
$table2->addCell()->addText($product->name);
$table2->addCell()->addText("Gs.".number_format($product->price_in,0,",","."));
$table2->addCell()->addText("Gs.".number_format($operation->q*$product->price_in,0,",","."));
$total+=$operation->q*$product->price_in;
}

$section1->addText("");
$section1->addText("Total: Gs.".number_format($total,0,",","."),array("size"=>20));
